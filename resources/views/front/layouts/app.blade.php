  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" id="profile_picture_form" name="profile_picture_form" >
            <div class="mb-3">
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© {{now()->format('Y')}} Aung Khant Zin, all rights reserved</p>
</div>
</footer> 
...
<script>
	...
	$('#profile_picture_form').submit(function(e) {
		...
		$.ajax({
			url: "{{route('account.update_profile_picture')}}",
			type: 'POST',
			data: formData,
			dataType: 'json',
			contentType: false,
